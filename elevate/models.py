...
class User(AbstractBaseUser):
    ...
    user_login = models.CharField(max_length=200, unique=True)##ldap creds
...
class ARTTable(models.Model):
    ...
    user = models.OneToOneField(User, to_field='user_id', on_delete=models.CASCADE, related_name='art_manager_user',default=None)
